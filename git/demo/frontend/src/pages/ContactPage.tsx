...
const ContactPage = () => {
  return (
    <section className="relative w-full min-h-screen py-16 px-6 bg-slate-950 text-white">
      <Seo
        title="Kontakt"
        description="Du suchst einen Entwickler für dein Softwareprojekt oder hast Fragen zum Twitch-Bot? Schreib mir eine Nachricht - ich melde mich schnellstmöglich zurück."
        path="/contact"
      />
